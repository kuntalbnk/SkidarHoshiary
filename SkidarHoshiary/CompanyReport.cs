...
{
    public partial class CompanyReport : MetroFramework.Forms.MetroForm
    {
      ...
      //  string cs = @"Data Source=AVIJAN-PC\SQLEXPRESS;Initial Catalog=SkidarHosiaryDB;Integrated Security=True";
        ...
        private void CompanyReport_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                bsource.DataSource = Process.ReportProcess.GetCompanyReportProcess();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                wb.SaveAs(folderPath + "CompanyList.xlsx");
                MessageBox.Show("Successfully Exported. your saved filepath is " + folderPath + "CompanyList.xlsx");
            }
        }
    }
}
