...
namespace SkidarHoshiary
{
    class DataGridPrinter
    {
        ...
        {
            SolidBrush ForeBrush = new SolidBrush(TheDataGrid.GridColor);
            SolidBrush BackBrush = new SolidBrush(TheDataGrid.GridColor);
        ...
        void DrawHorizontalLines(Graphics g, ArrayList lines)
        {
            ...
            //if (TheDataGrid.GridColor == DataGridLineStyle.None)
            //    return;
