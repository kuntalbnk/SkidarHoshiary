    ...
    public partial class PurchaseReport : MetroFramework.Forms.MetroForm
    {
        ...
        private void PurchaseReport_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                bsource.DataSource = Process.ReportProcess.GetPurchaseReportProcess();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                wb.Worksheets.Add(dt, "Purchase");
                wb.SaveAs(folderPath + "PurchaseReport.xlsx");
                MessageBox.Show("Successfully Exported. your saved filepath is " + folderPath + "PurchaseReport.xlsx");
            }
        }
    }
}
